...
var timerTime = null;
var timerLotall = null;
var timerLotdept = null;
var timerPurLess = null;
var timerPurMore = null;
var timerEnddate = null;
var timerUnsale = null;
var timerSalWeek = null;
var timerRsPur = null;
var timerRsApp = null;
var timerNumInfo = null;
var timerMid = null;
var timerInout = null;
var timerInMonth = null;
var timerOutMonth = null;
var timerSalUpTop = null;
var timerSalDownTop = null;
var timerBarDay = null;

function initData(deptId) {
    clearInterval(timerTime);
    clearInterval(timerLotall);
    clearInterval(timerLotdept);
    clearInterval(timerPurLess);
    clearInterval(timerPurMore);
    clearInterval(timerEnddate);
    clearInterval(timerUnsale);
    clearInterval(timerSalWeek);
    clearInterval(timerRsPur);
    clearInterval(timerRsApp);
    clearInterval(timerNumInfo);
    clearInterval(timerMid);
    clearInterval(timerInout);
    clearInterval(timerInMonth);
    clearInterval(timerOutMonth);
    clearInterval(timerSalUpTop);
    clearInterval(timerSalDownTop);
    clearInterval(timerBarDay);

    timerTime = setInterval(loadtime, 1 * 1000);
    timerLotall = setInterval(loadLotall.bind(this, deptId), loadLotallTime * 60000);
    timerLotdept = setInterval(loadLotdept, loadLotdeptTime * 60000);
    timerPurLess = setInterval(loadPurLess, loadPurLessTime * 60000);
    timerPurMore = setInterval(loadPurMore, loadPurMoreTime * 60000);
    timerEnddate = setInterval(loadEnddate, loadEnddateTime * 60000);
    timerUnsale = setInterval(loadUnsale, loadUnsaleTime * 60000);
    timerSalWeek = setInterval(loadSalWeek, loadSalWeekTime * 60000);
    timerRsPur = setInterval(loadRsPur, loadRsPurTime * 60000);
    timerRsApp = setInterval(loadRsApp, loadRsAppTime * 60000);
    timerNumInfo = setInterval(loadNumInfo, loadNumInfoTime * 60000);
    timerMid = setInterval(loadMid, loadMidTime * 60000);
    timerInout = setInterval(loadInout, loadInoutTime * 60000);
    timerInMonth = setInterval(loadInMonth, loadInMonthTime * 60000);
    timerOutMonth = setInterval(loadOutMonth, loadOutMonthTime * 60000);
    timerSalUpTop = setInterval(loadSalUpTop, loadSalUpTopTime * 60000);
    timerSalDownTop = setInterval(loadSalDownTop, loadSalDownTopTime * 60000);
    timerBarDay = setInterval(loadBarDay, loadBarDayTime * 60000);
...
function getBaseInfo() {
    var url = global_dept_url + "/getBaseInfo";
    $.ajax({
        url: url,
        type: "GET",
        success: function (dataJson) {
            if (dataJson.code == "1") {
                ...
                document.title = data.depttilte;
                $(".form-control").val(data.deptName);
                $("#title-span").text(data.deptName);

                initData(data.deptId);

                $("#depttilte").html(data.depttilte);
                $("#companyname").html(data.companyname);
                $("#hosname").html(data.hospname);
...
//全院备货构成
function loadLotall(deptId) {
    var url = global_dept_url + "/getLotall?deptId=" + deptId;
    $.ajax({
        url: url,
        type: "GET",
        success: function (dataJson) {
...
function loadLotdept() {
    var url = global_dept_url + "/getLotdept";
    $.ajax({
        url: url,
        type: "GET",
        success: function (dataJson) {
...
function loadPurLess() {
    var url = global_dept_url + "/getPurLess";
    $.ajax({
        url: url,
        type: "GET",
        success: function (dataJson) {
...
function loadPurMore() {
    var url = global_dept_url + "/getPurMore";
    $.ajax({
        url: url,
        type: "GET",
        success: function (dataJson) {
...
function loadEnddate() {
    var url = global_dept_url + "/getEnddate";
    $.ajax({
        url: url,
        type: "GET",
        success: function (dataJson) {
...
//滞销提醒
function loadUnsale() {
    var url = global_dept_url + "/getUnsale";
    $.ajax({
        url: url,
        type: "GET",
        success: function (dataJson) {
...
function loadSalWeek() {
    ...
    var y1 = [];
    var y2 = [];
    var url = global_dept_url + "/getSalWeek";
    $.ajax({
        url: url,
        type: "GET",
        success: function (dataJson) {
...
//采购监控
function loadRsPur() {
    var url = global_dept_url + "/getRsPur";
    $.ajax({
        url: url,
        type: "GET",
        success: function (dataJson) {
...
//科室监控
function loadRsApp() {
    var url = global_dept_url + "/getRsApp";
    $.ajax({
        url: url,
        type: "GET",
        success: function (dataJson) {
...
function loadNumInfo() {
    var url = global_dept_url + "/getNumInfo";
    $.ajax({
        url: url,
        type: "GET",
        success: function (dataJson) {
...
//科室备货使用
function loadMid() {
    var url = global_dept_url + "/getMid";
    $.ajax({
        url: url,
        type: "GET",
        success: function (dataJson) {
...
function loadInout() {
    ...
    var y1 = [];
    var y2 = [];
    var url = global_dept_url + "/getInout";
    $.ajax({
        url: url,
        type: "GET",
        success: function (dataJson) {
...
function loadInMonth() {
    var url = global_dept_url + "/getInMonth";
    $.ajax({
        url: url,
        type: "GET",
        success: function (dataJson) {
...
function loadOutMonth() {
    var url = global_dept_url + "/getOutMonth";
    $.ajax({
        url: url,
        type: "GET",
        success: function (dataJson) {
...
function loadSalUpTop() {
    var x = [];
    var y = [];
    var url = global_dept_url + "/getSalUpTop";
    $.ajax({
        url: url,
        type: "GET",
        success: function (dataJson) {
...
function loadSalDownTop() {
    var x = [];
    var y = [];
    var url = global_dept_url + "/getSalDownTop";
    $.ajax({
        url: url,
        type: "GET",
        success: function (dataJson) {
...
//当日消耗标签数
function loadBarDay() {
    var url = global_dept_url + "/getBarDay";
    $.ajax({
        url: url,
        type: "GET",
        success: function (dataJson) {
...
// //最新动态
// function loadNotice() {
// 	var url = global_dept_url + "/getNotice";
// 	$.ajax({
// 		url: url,
// 		type: "GET",
// 		success: function(dataJson) {
